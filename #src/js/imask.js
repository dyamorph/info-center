(function (global, factory) {
  ...
  function isObject(obj) {
    ...
    return (
      typeof obj === "object" &&
      obj != null &&
      (obj == null || (_obj$constructor = obj.constructor) == null ? void 0 : _obj$constructor.name) === "Object"
    );
  }
  ...
  class HTMLMaskElement extends MaskElement {
    ...
    get rootElement() {
      ...
      return (_this$input$getRootNo =
        (_this$input$getRootNo2 = (_this$input = this.input).getRootNode) == null ? void 0 : _this$input$getRootNo2.call(_this$input)) !=
        null
  ...
  class PatternCursor {
    ...
    _pushLeft(fn) {
      ...
      for (
        this.bindBlock();
        0 <= this.index;
        --this.index, this.offset = ((_this$block = this.block) == null ? void 0 : _this$block.displayValue.length) || 0
      ) {
        var _this$block;
  ...
  class PatternInputDefinition {
    ...
    currentMaskFlags(flags) {
      ...
      return {
        ...flags,
        _beforeTailState:
          (flags == null || (_flags$_beforeTailSta = flags._beforeTailState) == null ? void 0 : _flags$_beforeTailSta.masked) ||
  ...
  class MaskedPattern extends Masked {
    ...
    _rebuildMask() {
      ...
      for (let i = 0; i < pattern.length; ++i) {
        if (this.blocks) {
          ...
          if (bName) {
            const { expose, repeat, ...bOpts } = normalizeOpts(this.blocks[bName]); // TODO type Opts<Arg & Extra>
            const blockOpts = {
              lazy: this.lazy,
              eager: this.eager,
    ...
    _appendEager() {
      ...
      const details = new ChangeDetails();
      let startBlockIndex =
        (_this$_mapPosToBlock = this._mapPosToBlock(this.displayValue.length)) == null ? void 0 : _this$_mapPosToBlock.index;
    ...
    _appendCharRaw(ch, flags) {
      ...
      for (let bi = blockIter.index, block; (block = this._blocks[bi]); ++bi) {
        ...
        const blockDetails = block._appendChar(ch, {
          ...flags,
          _beforeTailState:
            (_flags$_beforeTailSta = flags._beforeTailState) == null || (_flags$_beforeTailSta = _flags$_beforeTailSta._blocks) == null
              ? void 0
  ...
  class MaskedDynamic extends Masked {
    ...
    currentMaskFlags(flags) {
      ...
      return {
        ...flags,
        _beforeTailState:
          (((_flags$_beforeTailSta = flags._beforeTailState) == null ? void 0 : _flags$_beforeTailSta.currentMaskRef) ===
            this.currentMask &&
            ((_flags$_beforeTailSta2 = flags._beforeTailState) == null ? void 0 : _flags$_beforeTailSta2.currentMask)) ||
  ...
  class RepeatBlock extends MaskedPattern {
    ...
    _update(opts) {
      ...
      super._update({
        mask: "m".repeat(
          Math.max(
            (this.repeatTo === Infinity && ((_this$_blocks = this._blocks) == null ? void 0 : _this$_blocks.length)) || 0,
            this.repeatFrom
          )
        ),
        blocks: {
      ...
      for (
        let bi =
            (_this$_mapPosToBlock$ =
              (_this$_mapPosToBlock = this._mapPosToBlock(this.displayValue.length)) == null ? void 0 : _this$_mapPosToBlock.index) != null
              ? _this$_mapPosToBlock$
    ...
    _trimEmptyTail(fromPos, toPos) {
      ...
      const firstBlockIndex = Math.max(
        ((_this$_mapPosToBlock2 = this._mapPosToBlock(fromPos)) == null ? void 0 : _this$_mapPosToBlock2.index) || 0,
        this.repeatFrom,
        0
      );
      let lastBlockIndex;
